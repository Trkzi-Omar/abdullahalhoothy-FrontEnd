...
const LandingHero = ({ t: copy }: LandingHeroProps) => {
    ...
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden min-h-screen flex items-center">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-white mb-6">{copy.cta.title}</h2>
          <p className="text-slate-400 text-xl mb-10 max-w-2xl mx-auto">{copy.cta.sub}</p>
            ...
            <div className="flex items-center justify-center lg:justify-start gap-4 text-xs font-medium text-slate-400">
              <span className="flex items-center gap-1">
                ...
                <span>{copy.hero.noCreditCard}</span>
              </span>
              <span className="flex items-center gap-1">
                <MdCheckCircleOutline size={14} className="text-brand-green" />
                <span>{copy.hero.instantReport}</span>
              </span>
            </div>
          </div>
          <div
