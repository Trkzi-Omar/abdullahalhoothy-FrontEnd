        ...
        <div className="font-sans text-[#1a1a1a] pt-6 px-5 pb-0 overflow-x-hidden min-h-full">
          <div className="max-w-[62.5rem] mx-auto">
            <div className="text-center mb-6">
              <h2 className="text-2xl font-bold text-[#1a1a1a]">{t("location-analysis-report")}</h2>
              <p className="text-[#666] text-[0.95rem] mt-2">{t("choose-your-report-option")}</p>
            </div>
          ...
          <div className="max-w-[62.5rem] mx-auto">
            ...
            <div className="grid grid-cols-[repeat(auto-fit,minmax(18rem,1fr))] gap-4">
              ...
              <div className="relative border-2 border-[#d1d5db] rounded-2xl p-6 bg-gradient-to-br from-[rgba(156,163,175,0.1)] to-[#f9fafb] shadow-[0_0.25rem_1rem_rgba(0,0,0,0.05)] opacity-75 cursor-pointer transition-all duration-[250ms] ease-in-out">
                ...
                <ul className="grid gap-[0.6rem] list-none p-0 mb-4">
                  <li className="flex items-center gap-2 text-[#1a1a1a] text-[0.9rem]"><span className="text-[#d1d5db] font-extrabold">✓</span>{t("compare-your-location-to-existing-database")}</li>
                  <li className="flex items-center gap-2 text-[#1a1a1a] text-[0.9rem]"><span className="text-[#d1d5db] font-extrabold">✓</span>{t("detailed-demographic-and-competitive-analysis")}</li>
                  <li className="flex items-center gap-2 text-[#1a1a1a] text-[0.9rem]"><span className="text-[#d1d5db] font-extrabold">✓</span>{t("instant-insights-and-recommendations")}</li>
                </ul>
                <a
                  href="/profile"
                  target='_blank'
              ...
              <div className="relative border-[3px] border-[rgba(125,0,184,0.7)] rounded-2xl p-6 shadow-[0_0.5rem_1.5rem_rgba(125,0,184,0.25)] transition-all duration-[250ms] ease-in-out hover:-translate-y-[3px] hover:shadow-[0_0.5rem_1.5rem_rgba(0,0,0,0.08)]" style={{ background: 'linear-gradient(135deg, rgba(125,0,184,0.06), rgba(72,158,70,0.08))' }}>
                ...
                <p className="text-[#666] text-[0.95rem] mb-4 leading-relaxed">
                  {locationReportPrice === null
                    ?t("unable-to-calculate-price-at-this-time")
                    :t("get-a-fresh-deep-dive-on-another-site-with-competitive-insights-and-instant-reco")}
                </p>
                ...
                {locationReportPrice === null && !isLoadingLocationPrice && (
                  ...
                  >{t("retry-price-calculation")}</button>
                )}

                <ul className="grid gap-[0.6rem] list-none p-0 mb-4">
                  <li className="flex items-center gap-2 text-[#1a1a1a] text-[0.9rem]"><span className="text-gem font-extrabold">✓</span>{t("compare-location-to-database")}</li>
                  <li className="flex items-center gap-2 text-[#1a1a1a] text-[0.9rem]"><span className="text-gem font-extrabold">✓</span>{t("detailed-demographic-analysis")}</li>
                  <li className="flex items-center gap-2 text-[#1a1a1a] text-[0.9rem]"><span className="text-gem font-extrabold">✓</span>{t("competitive-insights")}</li>
                  <li className="flex items-center gap-2 text-[#1a1a1a] text-[0.9rem]"><span className="text-gem font-extrabold">✓</span>{t("instant-recommendations")}</li>
                </ul>
                <button
                  type="button"
    ...
    return (
      <div className="font-sans text-[#1a1a1a] pt-6 px-5 pb-0 overflow-x-hidden min-h-full">
        <div className="max-w-[62.5rem] mx-auto">
          <div className="text-center mb-6">
            <h2 className="text-2xl font-bold text-[#1a1a1a]">{t("location-analysis-report")}</h2>
            <p className="text-[#666] text-[0.95rem] mt-2">{t("instant-analysis-comparing-your-location-to-our-database")}</p>
          </div>
          ...
          <div className="grid grid-cols-[repeat(auto-fit,minmax(18rem,1fr))] gap-4">
            <div className="relative border-2 border-[rgba(72,158,70,0.35)] rounded-2xl p-6 bg-white shadow-[0_0.25rem_1rem_rgba(0,0,0,0.05)] transition-all duration-[250ms] ease-in-out hover:-translate-y-[3px] hover:shadow-[0_0.5rem_1.5rem_rgba(0,0,0,0.08)]" style={{ background: 'linear-gradient(120deg, rgba(72,158,70,0.12), #fff)' }}>
              ...
              <p className="text-[#666] text-[0.95rem] mb-4 leading-relaxed">
                {locationReportPrice === null
                  ?t("unable-to-calculate-price-at-this-time-please-retry-to-continue")
                  : isFree
                  ?t("instant-analysis-comparing-your-location-to-our-database-perfect-for-your-first")
              ...
              <ul className="grid gap-[0.6rem] list-none p-0 mb-4">
                <li className="flex items-center gap-2 text-[#1a1a1a] text-[0.9rem]"><span className="text-brand-green font-extrabold">✓</span>{t("compare-your-location-to-existing-database")}</li>
                <li className="flex items-center gap-2 text-[#1a1a1a] text-[0.9rem]"><span className="text-brand-green font-extrabold">✓</span>{t("detailed-demographic-and-competitive-analysis")}</li>
                <li className="flex items-center gap-2 text-[#1a1a1a] text-[0.9rem]"><span className="text-brand-green font-extrabold">✓</span>{t("instant-insights-and-recommendations")}</li>
              </ul>
              <button
                type="button"
                disabled={disabled || locationReportPrice === null}
    ...
    <div className="font-sans text-[#1a1a1a] pt-6 px-5 pb-0 overflow-x-hidden min-h-full">
      <div className="max-w-[62.5rem] mx-auto">
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(18.75rem,1fr))] gap-7 mb-[3.75rem] max-md:grid-cols-1 max-md:gap-5">
          ...
          >
            <div className="mb-6">
              <div className="font-rajdhani text-[1.375rem] font-bold mb-2 text-[#1a1a1a] max-md:text-xl max-[30rem]:text-lg">{t("basic")}</div>
              <div className="text-[0.8125rem] text-[#666] leading-relaxed">{t("perfect-for-individual-location-research")}</div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="text-[0.8125rem] text-[#666]">{t("per-report")}</div>
            </div>
            ...
            <div className="my-5 mx-0 p-[0.9rem_1rem] rounded-[0.875rem] border border-[rgba(72,158,70,0.25)] shadow-[inset_0_0.5rem_1.4rem_rgba(72,158,70,0.08)]" style={{ background: 'linear-gradient(135deg, rgba(72,158,70,0.14) 0%, rgba(255,255,255,0.95) 65%)' }}>
              <div className="flex items-center justify-between gap-3 flex-wrap mb-2">
                <div className="inline-flex items-center gap-[0.375rem] text-[0.6875rem] font-bold text-brand-green uppercase tracking-[0.0625rem] font-rajdhani max-[30rem]:text-[0.625rem]">
                  <FaBrain className="text-sm" />{t("area-intelligence")}</div>
              </div>
            ...
            >{t("get-basic-report")}</button>

            <div className="mb-2 flex-grow">
              <div className="mb-5">
                <div className="text-[0.6875rem] font-bold text-brand-green uppercase tracking-[0.0312rem] mb-[0.625rem] font-rajdhani max-[30rem]:text-[0.625rem]">{t("core-features")}</div>
                <div className="flex items-center gap-[0.625rem] py-2 text-[0.8125rem] text-[#666] transition-colors duration-300 hover:text-[#1a1a1a] max-[30rem]:text-xs">
                  ...
                  <span>{t("top")}{' '}<strong>10</strong>{' '}{t("locations-ranked")}</span>
                </div>
                <div className="flex items-center gap-[0.625rem] py-2 text-[0.8125rem] text-[#666] transition-colors duration-300 hover:text-[#1a1a1a] max-[30rem]:text-xs">
                  <div className="w-[1.125rem] h-[1.125rem] rounded-full flex items-center justify-center shrink-0 text-[0.6875rem] text-white font-bold" style={{ background: 'linear-gradient(135deg, #489E46, #42dc56)' }}>✓</div>
                  <span>{t("preset-scoring-model")}</span>
                </div>
                <div className="flex items-center gap-[0.625rem] py-2 text-[0.8125rem] text-[#666] transition-colors duration-300 hover:text-[#1a1a1a] max-[30rem]:text-xs">
                  <div className="w-[1.125rem] h-[1.125rem] rounded-full flex items-center justify-center shrink-0 text-[0.6875rem] text-white font-bold" style={{ background: 'linear-gradient(135deg, #489E46, #42dc56)' }}>✓</div>
                  <span>{t("up-to")}{' '}<strong>5</strong> <abbr title={t("points-of-interest")}>{t("poi")}</abbr>{' '}{t("datasets")}</span>
                </div>
                <div className="flex items-center gap-[0.625rem] py-2 text-[0.8125rem] text-[#666] transition-colors duration-300 hover:text-[#1a1a1a] max-[30rem]:text-xs">
                  <div className="w-[1.125rem] h-[1.125rem] rounded-full flex items-center justify-center shrink-0 text-[0.6875rem] text-white font-bold" style={{ background: 'linear-gradient(135deg, #489E46, #42dc56)' }}>✓</div>
                  <span>{t("full-data-access")}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="mb-6">
              ...
              <div className="text-[0.8125rem] text-[#666] leading-relaxed">{t("for-growing-teams-and-enterprises")}</div>
            </div>
            ...
            <div className="mb-2 flex-grow">
              <div className="mb-5">
                ...
                <div className="flex items-center gap-[0.625rem] py-2 text-[0.8125rem] text-[#666] transition-colors duration-300 hover:text-[#1a1a1a] max-[30rem]:text-xs">
                  <div className="w-[1.125rem] h-[1.125rem] rounded-full flex items-center justify-center shrink-0 text-[0.6875rem] text-white font-bold" style={{ background: 'linear-gradient(135deg, #489E46, #42dc56)' }}>✓</div>
                  <span>{t("custom-scoring-model")}</span>
                </div>
                <div className="flex items-center gap-[0.625rem] py-2 text-[0.8125rem] text-[#666] transition-colors duration-300 hover:text-[#1a1a1a] max-[30rem]:text-xs">
                  <div className="w-[1.125rem] h-[1.125rem] rounded-full flex items-center justify-center shrink-0 text-[0.6875rem] text-white font-bold" style={{ background: 'linear-gradient(135deg, #489E46, #42dc56)' }}>✓</div>
                  <span>{t("up-to")}{' '}<strong>10</strong> <abbr title={t("points-of-interest")}>{t("poi")}</abbr>{' '}{t("datasets")}</span>
                </div>
                <div className="flex items-center gap-[0.625rem] py-2 text-[0.8125rem] text-[#666] transition-colors duration-300 hover:text-[#1a1a1a] max-[30rem]:text-xs">
                  <div className="w-[1.125rem] h-[1.125rem] rounded-full flex items-center justify-center shrink-0 text-[0.6875rem] text-white font-bold" style={{ background: 'linear-gradient(135deg, #489E46, #42dc56)' }}>✓</div>
                  <span>{t("full-data-access")}</span>
          ...
          >
            ...
            <div className="mb-6 featured-header-aura">
              ...
              <div className="text-[0.8125rem] text-[#666] leading-relaxed">{t("enterprise-grade-intelligence-suite")}</div>
            </div>
            ...
            <div className="my-5 mx-0 p-[0.9rem_1rem] rounded-[0.875rem] border border-[rgba(125,0,184,0.35)] shadow-[inset_0_0.5rem_1.4rem_rgba(125,0,184,0.08)]" style={{ background: 'linear-gradient(135deg, rgba(125,0,184,0.12) 0%, rgba(255,255,255,0.95) 70%)' }}>
              <div className="flex items-center justify-between gap-3 flex-wrap mb-2">
                <div className="inline-flex items-center gap-[0.375rem] text-[0.6875rem] font-bold text-gem uppercase tracking-[0.0625rem] font-rajdhani max-[30rem]:text-[0.625rem]">
                  <FaBrain className="text-sm" />{t("area-intelligence-pack")}</div>
              </div>
              <div className="grid grid-cols-2 gap-2">
            ...
            <div className="mb-2 flex-grow">
              <div className="mb-5">
                ...
                <div className="flex items-center gap-[0.625rem] py-2 text-[0.8125rem] text-[#666] transition-colors duration-300 hover:text-[#1a1a1a] max-[30rem]:text-xs">
                  <div className="w-[1.125rem] h-[1.125rem] rounded-full flex items-center justify-center shrink-0 text-[0.6875rem] text-white font-bold" style={{ background: 'linear-gradient(135deg, #7D00B8 0%, #7E22CE 100%)' }}>✓</div>
                  <span>{t("up-to")}{' '}<strong>15</strong> <abbr title={t("points-of-interest")}>{t("poi")}</abbr>{' '}{t("datasets")}</span>
                </div>
                <div className="flex items-center gap-[0.625rem] py-2 text-[0.8125rem] text-[#666] transition-colors duration-300 hover:text-[#1a1a1a] max-[30rem]:text-xs">
                  <div className="w-[1.125rem] h-[1.125rem] rounded-full flex items-center justify-center shrink-0 text-[0.6875rem] text-white font-bold" style={{ background: 'linear-gradient(135deg, #7D00B8 0%, #7E22CE 100%)' }}>✓</div>
                  <span>{t("full-data-access")}</span>
              ...
              <div className="mb-5">
                <div className="text-[0.6875rem] font-bold text-brand-green uppercase tracking-[0.0312rem] mb-[0.625rem] font-rajdhani max-[30rem]:text-[0.625rem]">{t("premium-support")}</div>
                <div className="flex items-center gap-[0.625rem] py-2 text-[0.8125rem] text-[#666] transition-colors duration-300 hover:text-[#1a1a1a] max-[30rem]:text-xs">
                  <div className="w-[1.125rem] h-[1.125rem] rounded-full flex items-center justify-center shrink-0 text-[0.6875rem] text-white font-bold" style={{ background: 'linear-gradient(135deg, #7D00B8 0%, #7E22CE 100%)' }}>✓</div>
                  <span>{t("concierge-service")}</span>
                </div>
                <div className="flex items-center gap-[0.625rem] py-2 text-[0.8125rem] text-[#666] transition-colors duration-300 hover:text-[#1a1a1a] max-[30rem]:text-xs">
                  <div className="w-[1.125rem] h-[1.125rem] rounded-full flex items-center justify-center shrink-0 text-[0.6875rem] text-white font-bold" style={{ background: 'linear-gradient(135deg, #7D00B8 0%, #7E22CE 100%)' }}>✓</div>
                  <span>{t("personal-business-consultant")}</span>
                </div>
                <div className="flex items-center gap-[0.625rem] py-2 text-[0.8125rem] text-[#666] transition-colors duration-300 hover:text-[#1a1a1a] max-[30rem]:text-xs">
                  <div className="w-[1.125rem] h-[1.125rem] rounded-full flex items-center justify-center shrink-0 text-[0.6875rem] text-white font-bold" style={{ background: 'linear-gradient(135deg, #7D00B8 0%, #7E22CE 100%)' }}>✓</div>
